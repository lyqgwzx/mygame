...
tile_images = {
    "草地": pygame.transform.scale(pygame.image.load(resource_path + "草地.png"), (50, 50)),
    "水泥地": pygame.transform.scale(pygame.image.load(resource_path + "道路.png"), (50, 50)),
    "鹅卵石路": pygame.transform.scale(pygame.image.load(resource_path + "鹅卵石路.png"), (50, 50)),
    "房子": pygame.transform.scale(pygame.image.load(resource_path + "房子.png"), (50, 50)),
    "路灯": pygame.transform.scale(pygame.image.load(resource_path + "路灯.png"), (50, 50)),
    "树": pygame.transform.scale(pygame.image.load(resource_path + "树.png"), (50, 50)),
    "灌木": pygame.transform.scale(pygame.image.load(resource_path + "灌木.png"), (50, 50)),
}
...
while running:
        ...
        if event.type == pygame.QUIT:
            ...
            if current_tile:
                if event.key == pygame.K_w:
                    current_tile_size += 5  # 放大
                elif event.key == pygame.K_s:
                    current_tile_size = max(5, current_tile_size - 5)  # 缩小，最小不能小于5
            else:
                if event.key == pygame.K_w:
                    camera_pos[1] -= 10
                elif event.key == pygame.K_s:
    ...
    if current_tile:
        ...
        preview_image = pygame.transform.scale(tile_images[current_tile], (current_tile_size, current_tile_size))
    ...
    for (x, y), (tile, size) in map_tiles.items():
        ...
        thumb_size = int(size * scale_factor)
        thumbnail_tile_rect = pygame.Rect(thumb_x, thumb_y, thumb_size, thumb_size)
        scaled_thumb_image = pygame.transform.scale(tile_images[tile], (thumb_size, thumb_size))
        thumbnail_surface.blit(scaled_thumb_image, thumbnail_tile_rect)
